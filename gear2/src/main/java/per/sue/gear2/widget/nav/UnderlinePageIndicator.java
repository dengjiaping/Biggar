...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    private GearTabPageIndicator gearTabPageIndicator;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(null != gearTabPageIndicator){
            View currentTab = gearTabPageIndicator.getSelectTabView();
    ...
    public void setGearTabPageIndicator(GearTabPageIndicator gearTabPageIndicator) {
        this.gearTabPageIndicator = gearTabPageIndicator;
    }
}