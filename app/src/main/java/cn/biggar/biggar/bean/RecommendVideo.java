...
public class RecommendVideo {
     ...
     * E_Name : 那些上太空你不知道的事
     * E_ProductID : 0
     * E_Path : http://biggar.file.alimmdn.com/upload/1AF8C8A4-8BA5-4C72-B82F-0C7384535EAD
     * E_Language : cn
     * E_CreateUser : 18602090037
     * E_CreateDate : 1464341137
     * E_UpdateUser : null
     * E_UpdateDate : 1464341137
     * E_CreateIP : 116.23.231.162
     * E_State : 1
     * E_Index : 8
     * E_MemberID : 1014
     * E_TypeVal : 0
     ...
     * E_Points : 0
     * E_Plays : 146
     * E_Img1 : http://biggar.image.alimmdn.com/upload/F6294F2E-DF45-41ED-99AB-514CC2C45FD2
     * E_Content : 我上戰機啦！#科技#
     * E_Comments : 0
     * E_Type : .Brand
     * E_Concerns : 1
     * E_Img2 : http://biggar.image.alimmdn.com/upload/BD3491D1-0688-4465-8ED2-A38B06BDAFC4
     * E_Tags : 科技
     * E_GiftPoints : 0
     * E_Img3 : null
     * E_Share : 0
    ...
    public RecommendVideo(String videoConverURL, String playTimes, String commentCount, String title, String describe, String avatar, String name) {
        this.videoConverURL = videoConverURL;
    ...
    public String getVideoConverURL() {
        return videoConverURL;
    }

    public void setVideoConverURL(String videoConverURL) {
        this.videoConverURL = videoConverURL;
    }
