...
public class MulitStatusView extends FrameLayout {
    ...
    public MulitStatusView(Context context) {
        this(context, null);
    }

    public MulitStatusView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MulitStatusView(Context context, AttributeSet attrs, int defStyle) {
