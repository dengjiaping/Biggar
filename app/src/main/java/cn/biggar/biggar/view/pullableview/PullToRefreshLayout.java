...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    // 下拉刷新与 底部加载更多的开关
    private boolean mSwitchPullRefresh = true;
    private boolean mSwitchLoadMore = true;
     ...
     * @param result
     */
    public void setPullRefresh(boolean result) {
        this.mSwitchPullRefresh = result;
    }
     ...
     * @param result
     */
    public void setLoadMore(boolean result) {
        this.mSwitchLoadMore = result;
    }
...
//                    refreshingView.startAnimation(refreshingAnimation);
            ...
            case MotionEvent.ACTION_MOVE:
                if (mEvents == 0) {
                    if (pullDownY > 0
                            ...
                            && canPullDown && mSwitchPullRefresh && state != LOADING)) {
                        // 可以下拉，正在加载时不能下拉
                        // 对实际滑动距离做缩小，造成用力拉的感觉
                        ...
                        if (state == REFRESHING) {
                            ...
                            || (((Pullable) pullableView).canPullUp() && canPullUp && mSwitchLoadMore && state != REFRESHING)) {
                        // 可以上拉，正在刷新时不能上拉
    ...
    private void initView() {
        ...
        mLoadingAnim= (AnimationDrawable) refreshingView.getBackground();
