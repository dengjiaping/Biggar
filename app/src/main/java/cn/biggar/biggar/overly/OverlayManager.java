package cn.biggar.biggar.overly;
...
public abstract class OverlayManager implements OnMarkerClickListener, OnPolylineClickListener {
     ...
     * @param baiduMap
     */
    public OverlayManager(BaiduMap baiduMap, LatLng startLatLng, LatLng endLatLng) {
        mBaiduMap = baiduMap;
    ...
    public void zoomToSpan() {
        ...
        if (mOverlayList.size() > 0) {
            ...
            MapStatusUpdate u = MapStatusUpdateFactory.zoomTo(curZoom - 0.3f);
