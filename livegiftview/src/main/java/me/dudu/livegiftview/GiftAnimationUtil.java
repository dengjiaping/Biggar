...
public class GiftAnimationUtil {
    ...
    public static ObjectAnimator createGiftNumberAnimator(TextView target) {
        PropertyValuesHolder anim1 = PropertyValuesHolder.ofFloat("scaleX", 1.5f, 0.8f, 1f);
        PropertyValuesHolder anim2 = PropertyValuesHolder.ofFloat("scaleY", 1.5f, 0.8f, 1f);
        PropertyValuesHolder anim3 = PropertyValuesHolder.ofFloat("alpha", 1.0f, 0f, 1f);
        return ObjectAnimator.ofPropertyValuesHolder(target, anim1, anim2, anim3).setDuration(300);
    }
