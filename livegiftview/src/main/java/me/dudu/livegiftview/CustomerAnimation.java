 ...
 * Description :
 */
public class CustomerAnimation implements ICustomerAnimation {
...
//        viewHolder.getGiftNumberView().setVisibility(View.INVISIBLE);
        //布局飞入
        ObjectAnimator animator1 = GiftAnimationUtil.createTranslationXAnimator(viewHolder.getGiftContainerView(), -giftFrameLayout.getWidth(), 0, 400, new DecelerateInterpolator());
