    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == PictureConfig.TYPE_CAMERA) {
            ...
            contentHolder.ll_check.setVisibility(selectMode ==
                    PictureConfig.SINGLE || picture == PictureConfig.TYPE_VIDEO ? View.GONE : View.VISIBLE);
            ...
            contentHolder.contentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (picture == PictureConfig.TYPE_IMAGE && (enablePreview
                        ...
                        if (!TextUtils.isEmpty(pictureType) && !PictureMimeType.mimeToEqual(pictureType, image.getPictureType())) {
